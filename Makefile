artifact_name       := certified-copies.orders.api.ch.gov.uk
version             := "unversioned"
...
dependency-check:
	...
	DEPENDENCY_CHECK_SUPPRESSIONS_HOME="$${suppressions_home}" "$${suppressions_home}/scripts/depcheck" --repo-name=certified-copies.orders.api.ch.gov.uk
